...
foreach x of numlist 2017/2023 {
global ao=`x'
global L="F"

cd "C:/Users/User/OneDrive - MIGRACIÓN VIDENZA/1. Proyectos/1. Proyectos actuales/23. Artículos PDB/2. PDB - Pobreza Urbana/2. Data/1. Bases/2. ENAHO Anual"
global enaho "C:\Users\User\OneDrive - Universidad del Pacífico\1. Documentos\0. Bases de datos\02. ENAHO\1. Data\Anual"
global temp  "C:/Users/User/OneDrive - MIGRACIÓN VIDENZA/1. Proyectos/1. Proyectos actuales/23. Artículos PDB/2. PDB - Pobreza Urbana/2. Data/1. Bases/2. ENAHO Anual"
...
keep a?o conglome mes ubigeo dominio vivienda hogar estrato codperso p201 p203 p204 p205 p206 p207 p208* facpob07
keep if p204==1
...
*esto estaba antes con asterisco
*keep a?o mes conglome vivienda hogar p101 p102 p103* p104 p110* p111* p112* p113* p203 p204 p205 p206 p207 p208* p301* p302* p306 p307 p308* p402* p403* p409* p419* p513* p514* p518* p519* p520* p521* p558* p556* ocu500 p801* p806 p37 p39b1
*-------------------------------------------------------------------------------
*** Dimensión: SALUD
*-------------------------------------------------------------------------------
...
gen     asistencia_hog = 1 if num_sin_educ5_19_hog>=1 & num_sin_educ5_19_hog!=.
replace asistencia_hog = 0 if num_sin_educ5_19_hog==0 & num_educ5_19_miss==0
replace asistencia_hog = 0 if num_5_19==0
...
gen c_i = 1/14 * (atencion_hog + seguro_hog + asistencia_hog + logro_hog + materiales + hacinamiento + agua + saneamiento + electricidad + combustible + empleo_hog + pension_hog + redes + comunicacion)
...
svy: mean pobre_6_14, over(nacional)
svy: mean pobre_mon, over(nacional)
svy: mean pmon_pmul, over(nacional)
mean pmon_pmul, over(nacional)
...
mat define mat1_`nivel'_${ao} = e(b)

svy: mean pobre_mon, over(`nivel')
mat define mat2_`nivel'_${ao} = e(b)

svy: mean pmon_pmul, over(`nivel')
...
foreach nivel in nacional rural {
	foreach var of varlist atencion_hog seguro_hog asistencia_hog logro_hog materiales hacinamiento agua saneamiento electricidad combustible empleo_hog pension_hog redes comunicacion {
		svy: mean `var', over(`nivel')
		mat define mat_`var'_`nivel'_${ao} = e(b)
	}
}

}

matrix rowjoinbyname mat1_nacional = mat1_nacional_2017 mat1_nacional_2018 mat1_nacional_2019 mat1_nacional_2020 mat1_nacional_2021 mat1_nacional_2022 mat1_nacional_2023
matrix rowjoinbyname mat2_nacional = mat2_nacional_2017 mat2_nacional_2018 mat2_nacional_2019 mat2_nacional_2020 mat2_nacional_2021 mat2_nacional_2022 mat2_nacional_2023
matrix rowjoinbyname mat3_nacional = mat3_nacional_2017 mat3_nacional_2018 mat3_nacional_2019 mat3_nacional_2020 mat3_nacional_2021 mat3_nacional_2022 mat3_nacional_2023
matrix rownames mat1_nacional = 2017 2018 2019 2020 2021 2022 2023
matrix rownames mat2_nacional = 2017 2018 2019 2020 2021 2022 2023
matrix rownames mat3_nacional = 2017 2018 2019 2020 2021 2022 2023

matrix rowjoinbyname mat1_rural = mat1_rural_2017 mat1_rural_2018 mat1_rural_2019 mat1_rural_2020 mat1_rural_2021 mat1_rural_2022 mat1_rural_2023
matrix rowjoinbyname mat2_rural = mat2_rural_2017 mat2_rural_2018 mat2_rural_2019 mat2_rural_2020 mat2_rural_2021 mat2_rural_2022 mat2_rural_2023
matrix rowjoinbyname mat3_rural = mat3_rural_2017 mat3_rural_2018 mat3_rural_2019 mat3_rural_2020 mat3_rural_2021 mat3_rural_2022 mat3_rural_2023
matrix rownames mat1_rural = 2017 2018 2019 2020 2021 2022 2023
matrix rownames mat2_rural = 2017 2018 2019 2020 2021 2022 2023
matrix rownames mat3_rural = 2017 2018 2019 2020 2021 2022 2023

matrix coljoinbyname mattriz = mat1_nacional mat2_nacional mat3_nacional mat1_rural mat2_rural mat3_rural
matrix rownames mattriz = 2017 2018 2019 2020 2021 2022 2023
mat list mattriz

foreach var of varlist atencion_hog seguro_hog asistencia_hog logro_hog materiales hacinamiento agua saneamiento electricidad combustible empleo_hog pension_hog redes comunicacion {
	foreach nivel in nacional rural {
		matrix rowjoinbyname mat_`var'_`nivel' = mat_`var'_`nivel'_2017 mat_`var'_`nivel'_2018 mat_`var'_`nivel'_2019 mat_`var'_`nivel'_2020 mat_`var'_`nivel'_2021 mat_`var'_`nivel'_2022 mat_`var'_`nivel'_2023
	}
	matrix coljoinbyname mat_`var' = mat_`var'_nacional mat_`var'_rural
	matrix rownames mat_`var' = 2017 2018 2019 2020 2021 2022 2023
}

foreach var of varlist atencion_hog seguro_hog asistencia_hog logro_hog materiales hacinamiento agua saneamiento electricidad combustible empleo_hog pension_hog redes comunicacion {
	mat list mat_`var'
}
matrix coljoinbyname matriz_priv = mat_atencion_hog mat_seguro_hog mat_asistencia_hog mat_logro_hog mat_materiales mat_hacinamiento mat_agua mat_saneamiento mat_electricidad mat_combustible mat_empleo_hog mat_pension_hog mat_redes mat_comunicacion
mat list matriz_priv
